    ...
    <div class="view-container">
        ...
        <div class="container-main">
            ...
            <div class='chart-container'>
                <div class="chart" id="bindChart"></div>
            </div>
...
export default {
    ...
    methods: {
        getCharts () {
            ...
            _vm.tableLoad = true
            _vm.$http.get({
                url: 'doct-webManager/charts/binds_charts.jhtml',
                data: _data,
        ...
        initChart () {
            let _vm = this
            _vm.chart = echarts.init(document.getElementById('bindChart'))
            _vm.chart.setOption({
                legend: {
                    itemWidth: 20,
                    itemHeight: 10,
