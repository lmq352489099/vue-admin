  ...
  <div class="view-container">
    ...
    <div class="container-main">
      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="160">
        <FormItem label="身份证号码" prop="identity" style="width:368px;marginLeft:-70px;" :rules="[{ required: true, message: '请输入身份证号码!'},
        ...
        <div class="upload-photo-item">
          <Upload ref="upload" :before-upload="handleBeforeUpload1" type="drag" action="//" style="display: inline-block;width:96px;">
        ...
        <div class="upload-photo-item">
          <Upload ref="upload" :before-upload="handleBeforeUpload2" type="drag" action="//" style="display: inline-block;width:96px;">
            <div class="photo-content">
              <div class="photo-icon"></div>
              <p>上传照片</p>
            </div>
        ...
        <br><br>
        <div class="upload-photo-item">
          <Upload ref="upload" :before-upload="handleBeforeUpload3" type="drag" action="//" style="display: inline-block;width:96px;">
            <div class="photo-content">
              <div class="photo-icon"></div>
              <p>上传照片</p>
            </div>
        ...
        <div class="upload-photo-item">
          <Upload ref="upload" :before-upload="handleBeforeUpload4" type="drag" action="//" style="display: inline-block;width:96px;">
            <div class="photo-content">
              <div class="photo-icon"></div>
              <p>上传照片</p>
            </div>
        ...
        <div class="upload-photo-item">
          <Upload ref="upload" :before-upload="handleBeforeUpload5" type="drag" action="//" style="display: inline-block;width:96px;">
            <div class="photo-content">
              <div class="photo-icon"></div>
              <p>上传照片</p>
            </div>
      ...
      <p class="step" style="marginTop:50px;">
        ...
        <span style="borderRadius:3px;" @click="jump()"> 跳过认证</span>
      </p>
    </div>
        ...
        if (valid) {
          ...
          _vm.$http.post({
            ...
            data: {
              ...
              profDocterRegisterCer2: _vm.urlList[4],
